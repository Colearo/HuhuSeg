...
# k = KeywordsEx('共享单车、共享充电宝、共享雨伞、共享KTV、共享睡眠舱……共享经济在过去的一年显得异常耀眼。而当资本的热潮退去，各种凑热闹、赶风口、投机套利、被过度催熟的公司开始退出市场。据不完全统计，目前共有19家投身共享经济的企业宣告倒闭或终止服务。与此同时，有人却打起了这批或报废或暂无运营方的产品的主意。近日，北京晚报记者调查发现，有不少废品回收站回收报废或无主共享单车当做废铝卖，一些个人也“收集”废弃或经营方倒闭的共享单车、共享充电宝等在二手网站上自行交易。律师表示，大量收集、转卖超出无产权证明的共享产品并以此牟利，轻则构成侵权，重则有可能涉嫌构成盗窃罪。')
...
k = TFIDF("""《旅行青蛙》目前仍是App Store中国区免费游戏下载榜榜首。
...
list = k.extract_kw(top_n = 5, combine_mode = True)
